...
function getToken(rand,cookies) {
var rand = rand;
var cookies = cookies;
var src = "http://class.seig.edu.cn:7001/sise/" + cookies + rand;
var md5 = heheda(src).toLocaleUpperCase();
var token = patch(md5, rand);
return token
};